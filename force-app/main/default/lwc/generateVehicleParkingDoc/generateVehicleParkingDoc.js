...
import generateVehicleParkingDocument from '@salesforce/apex/digioSubRepository.generateVehicleParkingDocument';
...
export default class GenerateVehicleParkingDoc extends LightningElement {
    // @api recordId;
    // @track subDocUrl = '';
    // @track loaded = false;
    ...
    // generateDocument() {
    //     generateVehicleParkingDocument({ recordId: this.recordId })
    //         .then(result => {
         ...
         sendEmailtoCustomerwithAttachment() {
                        ...
                        if (this.digioID) {
                           // this.showSpinner = true;
                            ...
                            sendigiodetails({ digiDocId: this.digioID ,oppId : this.recordId,docname : 'GenerateVehiclePark' })
                                .then(() => {
                                   // this.showSpinner = false;
