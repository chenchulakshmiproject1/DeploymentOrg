...
import getOnLoadData from '@salesforce/apex/GenerateCostSheetController.getOnLoadData';
import getUnitRecord from '@salesforce/apex/GenerateCostSheetController.getUnitRecord';
import getDiscountConfig from '@salesforce/apex/GenerateCostSheetController.getDiscountConfig';
import getTemplateData from '@salesforce/apex/GenerateCostSheetController.getTemplateData';
import getParkingRecords from '@salesforce/apex/GenerateCostSheetController.getParkingRecords';
import saveAllCostSheetData from '@salesforce/apex/GenerateCostSheetController.saveAllCostSheetData';

import modal from "@salesforce/resourceUrl/QuickActionCSS";


export default class GenerateCostSheetComp extends NavigationMixin(LightningElement) {
    ...
    wiredData(result) {
        console.log('recordId being sent:', this._recordId);
