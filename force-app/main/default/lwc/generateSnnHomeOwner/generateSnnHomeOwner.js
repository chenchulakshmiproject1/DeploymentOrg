...
import generateSnnHomeOwner from '@salesforce/apex/digioRepository.generateSnnHomeOwner';
...
export default class GenerateSnnHomeOwner extends LightningElement {
    ...
    // generateDocument() {
    //     generateSnnHomeOwner({ oppId: this.recordId })
    //         .then(result => {
        ...
        generateDocument(){
         ...
         sendEmailtoCustomerwithAttachment() {
                        ...
                        if (this.digioID) {
                            ...
                            sendigiodetails({ digiDocId: this.digioID ,oppId : this.recordId,docname : 'SNNHomeOwner' })
                                .then(() => {
                                   // this.showSpinner = false;
