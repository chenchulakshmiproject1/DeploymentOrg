...
import generateStatementOfAccounts from '@salesforce/apex/digioRepository.generateStatementOfAccounts';
...
export default class StatementOfAccounts extends LightningElement {
    ...
    // generateDocument() {
    //     debugger;
    //     generateStatementOfAccounts({ oppId: this.recordId })
    //         .then(result => {
     ...
     @api recordId;
        ...
        sendEmailtoCustomerwithAttachment() {
                        ...
                        if (this.digioID) {
                            ...
                            sendigiodetails({ digiDocId: this.digioID ,oppId : this.recordId, docname : 'StatementOfAccounts'})
                                .then(() => {
                                   // this.showSpinner = false;
