...
import generateMoveInMoveOutDocument from '@salesforce/apex/digioSubRepository.generateMoveInMoveOutDocument';
...
export default class GenerateMoveInMoveOutDoc extends LightningElement {
    // @api recordId;
    // @track subDocUrl = '';
    // @track loaded = false;
    ...
    // generateDocument() {
    //     generateMoveInMoveOutDocument({ recordId: this.recordId })
    //         .then(result => {
     ...
     @api recordId;
        ...
        sendEmailtoCustomerwithAttachment() {
                        ...
                        if (this.digioID) {
                            ...
                            sendigiodetails({ digiDocId: this.digioID ,oppId : this.recordId,docname : 'MoveInMoveOutDocument' })
                                .then(() => {
                                    //this.showSpinner = false;
