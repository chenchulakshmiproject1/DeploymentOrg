...
import generateWelcomeKit from '@salesforce/apex/digioRepository.generateWelcomeKit';
...
export default class GenerateWelcomeKit extends LightningElement {
    ...
    @api recordId;
        ...
        generateDocument(){
            debugger;
            generateWelcomeKit({oppId : this.recordId})
            .then(result => {
    ...
    sendEmailtoCustomerwithAttachment() {
                   ...
                   if (this.digioID) {
                       ...
                       sendigiodetails({ digiDocId: this.digioID ,oppId : this.recordId,docname : 'GenerateWelcomKit' })
                           .then(() => {
