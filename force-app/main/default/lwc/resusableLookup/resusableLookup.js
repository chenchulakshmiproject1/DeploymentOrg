...
export default class ResusableLookup extends LightningElement {
    ...
    @api firstFieldFilterApiName= "";
    @api firstFieldFilterValue= "";
    @api secondFieldFilterApiName= "";
    @api secondFieldFilterValue= "";
    @api thirdFieldFilterApiName= "";
    @api thirdFieldFilterValue= "";
    @api disabled;
    ...
    get methodInput() {
        ...
        return {
            ...
            firstFieldFilterApiName: this.firstFieldFilterApiName,
            firstFieldFilterValue: this.firstFieldFilterValue,
            secondFieldFilterApiName: this.secondFieldFilterApiName,
            secondFieldFilterValue: this.secondFieldFilterValue,
            thirdFieldFilterApiName: this.thirdFieldFilterApiName,
            thirdFieldFilterValue: this.thirdFieldFilterValue
        };
    }
