...
import generateServiceProviderContactsListDoc from '@salesforce/apex/digioSubRepository.generateServiceProviderContactsListDoc';
import sendigiodetails from '@salesforce/apex/digioSubRepository.sendigiodetails';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
import { CloseActionScreenEvent } from 'lightning/actions'; 
import DOWNLOAD_IMG from '@salesforce/resourceUrl/downloadingFile';

export default class GenerateServiceProvidersContactsList extends LightningElement {
    ...
    // generateDocument() {
    //     generateServiceProviderContactsListDoc({ recordId: this.recordId })
    //         .then(result => {
    ...
    // }
        ...
        sendEmailtoCustomerwithAttachment() {
                        ...
                        if (this.digioID) {
                            ...
                            sendigiodetails({ digiDocId: this.digioID ,oppId : this.recordId,docname : 'Serviceprovider' })
                                .then(() => {
                                   // this.showSpinner = false;
